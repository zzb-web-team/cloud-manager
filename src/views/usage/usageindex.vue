	...
	<section class="myself-container content">
		...
		<div class="user-title" style="display: flex;flex-flow: column;">
			<div class="resources_con">
				<div
					style="display: flex;flex-flow: row;margin-top: 20px;padding:20px 37px;background:rgba(255,255,255,1);box-shadow:0px 2px 3px 0px rgba(6,17,36,0.14);border-radius:2px;"
				>
					<el-input
			...
			getterminal(param)
				.then((res) => {
					if (res.status == 0) {
						...
						this.options1chanid = this.options1chanid.concat(
							this.labelData
						);
