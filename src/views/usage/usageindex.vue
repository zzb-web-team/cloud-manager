    ...
    <section class="myself-container content">
        ...
        <div class="user-title" style="display: flex;flex-flow: column;">
            <div class="resources_con">
                ...
                <div class="device_form" style="    display: flex;justify-content: flex-start;">
                    ...
                    <el-select v-model="valuess" filterable placeholder="请选择" :multiple="true" :collapse-tags="true" @change="onblurs">
                        <el-option v-for="item in optionssearch" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                    </el-select>
                    <el-button style="margin-left:10px;" type="primary" @click="querychanIds()">确定</el-button>
                </div>
...
export default {
  ...
  methods: {
    ...
    querychanIds() {
      this.gettable1(this.chanIds)
       this.gettable2(this.chanIds)
      ...
      (params.pageNo = 0),
        ...
        manage_dataflow_curve(params)
          .then(res => {
           ...
           // this.getbot();
            this.drawLine(nowarr, this.timeArray);
          })
          .catch(err => {
            console.log(err);
          });
      ...
      (params.pageNo = this.pageNo-1),
        ...
        manage_dataflow_table(params)
          .then(res => {
            ...
            //        res.data.data.dataflowArray.forEach((item, index) => {
           ...
           // this.drawLine(this.dataFlowArray2, this.timeArray2);
...
//   if (data == 1) {
    ...
    drawLine(x,y) {
      ...
      let options = {
        color: ["#99ccff", "#ffcc66", "#4cabce", "#999999"],
        tooltip: {
          trigger: "axis",
          axisPointer: {
            type: "shadow",
