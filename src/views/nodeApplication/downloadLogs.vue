  ...
  <div class="content">
    ...
    <div class="log_download_con">
      ...
      <el-table :data="tablecdn" stripe style="width: 100%;" :cell-style="rowClass" :header-cell-style="headClass">
        <el-table-column prop="fileName" label="日志数据包" width="360px"></el-table-column>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button @click.native.prevent="dloadRow(scope.row)" type="text" size="small">下载</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div style="display: flex;justify-content: space-between;align-items: center;">
        <div class="log_download_con_bot">
          <el-button type="text" size="small" @click="dloadRow()" v-if="tablecdn.length > 0">全部下载</el-button>
        </div>
