  ...
  <div class="content">
    <div class="content_top">
      <div class="content_top_left">
        <p class="more"
           @click="go_trafficMonitor">More <i class="el-icon-arrow-right"></i></p>
        <div class="content_top_left_con_top">
          <div class="content_top_left_con_img">
            <img src="../../assets/img/un_img.png"
                 alt="" />
            <div>
              <p>
                {{todayTotal|setbytes}} <span>{{todayTotal|set_bkb}}</span><img src="../../assets/img/fall.png"
                     alt="" />
              </p>
              <p>今日节点总流量</p>
            </div>
      ...
      <div class="content_top_right">
        <div class="content_top_right_text">
          <div>
            <p class="all_f">
              {{todayPV}} <img src="../../assets/img/fall.png"
                   alt="" /></i>
            </p>
            <p>今日访问总次数(PV)</p>
            <p>{{yesterdayPV}}</p>
          ...
          <div>
            <p class="all_f">
              {{todayUV}} <img src="../../assets/img/xiajiang.png"
                   alt="" /></i>
            </p>
            <p>今日独立IP访问数(UV)</p>
            <p>{{yesterdayUV}}</p>
        ...
        <div ref="pupvEcharts_con"
             class="content_top_right_echarts">
          <p class="more"
             @click="go_pupv">More <i class="el-icon-arrow-right"></i></p>
          <div id="pupv_echarts"
               :style="{ height: pvpu_e_h }"></div>
        </div>
      </div>
    </div>
    <div class="content_bottom"
      ...
      <div class="content_bottom_left">
        <div class="content_bottom_left_text">
          <div>
            <img src="../../assets/img/bgc_left_one.png"
                 alt="" />
          </div>
          <div>
            <p class="content_bottom_left_title">
              {{todayUnhandleReq}} <img src="../../assets/img/fall.png"
                   alt="" /></i>
            </p>
            <p>今日未处理访问总次数</p>
          </div>
        ...
        <div class="content_bottom_left_echarts">
          <p class="more"
             @click="go_playTraffic">More <i class="el-icon-arrow-right"></i></p>
          <div id="p2p_echarts"
               :style="{ height: p2p_e_h }"></div>
        </div>
      </div>
      <div class="content_bottom_right">
        <p class="more"
           @click="go_unprocessedTab">
        ...
        <div>
          <el-table :data="tableData"
            ...
            <el-table-column prop="visit_cnt"
                             label="访问总次数"
                             width="120">
            </el-table-column>
...
export default {
  ...
  mounted() {
    ...
    window.onresize = function () {
      ...
      if (that.$refs.scrollerHeight) {
        that.$refs.scrollerHeight.style.height = that.clientHeight - 580 + 'px'
        that.$refs.scrollerHeight.style.minHeight = 500 + 'px'
      }
    }
    this.pvpu_e_h = `${this.$refs.pupvEcharts_con.clientHeight - 60}px`
    console.log(this.clientHeight - 835)
    let p2p_min_h =
      this.clientHeight - 835 < 255 ? 255 : this.clientHeight - 835
    this.p2p_e_h = `${p2p_min_h}px`
  ...
  methods: {
    ...
    drawLine() {
      let _this = this
      // 初始化echarts实例
      let myChart = this.$echarts.init(document.getElementById('pupv_echarts'))
    ...
    drawLine2(x, y, z, a) {
      ...
      let myChart = this.$echarts.init(document.getElementById('p2p_echarts'))
    ...
    changeFixed(data) {
      if (this.$refs.scrollerHeight) {
        this.$refs.scrollerHeight.style.height = data - 560 + 'px'
