                ...
                <el-form ref="form" :model="form">
                    ...
                    <el-row type="flex" class="row_activess" v-show="showState"> -->
                        ...
                        <!-- <el-form-item label="注册时间" style="display: flex;"> -->
                            <el-date-picker style="margin-right: 10px;" v-model="valueTime" type="daterange" :picker-options="pickerOptions" range-separator="~" start-placeholder="开始日期" end-placeholder="结束日期">
                            </el-date-picker>
                        <!-- </el-form-item> -->
                        <!-- <el-form-item>
