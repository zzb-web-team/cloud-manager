<template>
<el-table border stripe :data="tableData" ref="table" style="width: 100%" @selection-change="handleSelectionChange" @sort-change='tableSortChange'  @select="selectCheckBox" @select-all="selectAll" :cell-style="rowClass" :header-cell-style="headClass" id="rebateSetTable">
